...
// --- BẮT ĐẦU SỬA LỖI ---
// 1. Thay đổi đường dẫn import từ '../services/api' thành '../../services/adminApi'
// 2. Thay đổi tên import từ 'api' thành 'adminApi' để khớp với endpoint quản trị
...
const MenuBar = ({ editor, onHtmlToggle, isHtmlMode }) => {
    ...
    const handleFileSelect = async (event) => {
        ...
        try {
            // --- BẮT ĐẦU SỬA LỖI ---
            // 3. Sử dụng 'adminApi' thay vì 'api' để gọi đúng backend
            const response = await adminApi.post('/admin/pages/upload-image', formData, {
