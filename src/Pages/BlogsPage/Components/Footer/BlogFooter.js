                ...
                <div className="blogs-footer__container">
                    <div className="blogs-newsletter">
                        <div className="blogs-newsletter__content">
                            <h3 className="blogs-newsletter__title">Đăng ký nhận bản tin iCards</h3>
                ...
                <div className="blogs-footer__container">
                    <div className="blogs-footer__grid">
                        ...
                        <div className="blogs-footer__col blogs-footer__col--brand">
                            <h2 className="blogs-footer__logo">iCards <span className="highlight">INSIGHTS</span></h2>
                        ...
                        {/* Column 3: Company */}
                        <div className="blogs-footer__col">
                            <h4 className="blogs-footer__heading">Về iCards</h4>
                            <ul className="blogs-footer__links">
            ...
            <div className="blogs-footer__bottom">
                <div className="blogs-footer__container">
                    <div className="blogs-copyright">
                        <p>&copy; {new Date().getFullYear()} iCards Vietnam. All rights reserved.</p>
                        <p className="blogs-made-with">
                            Made with <Heart size={14} fill="#ef4444" color="#ef4444" /> by iCards Team
                        </p>
                    </div>
                </div>
            </div>
